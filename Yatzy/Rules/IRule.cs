...
{
    /// <summary>
    /// Checks if the <see cref="CalculatePoints(IReadOnlyCollection{TDice})"/> is applicable to the current hand.
    /// </summary>
    ...
    bool IsApplicable(IReadOnlyCollection<TDice> hand);
    /// <summary>
    ...
    Points CalculatePoints(IReadOnlyCollection<TDice> hand);
}
